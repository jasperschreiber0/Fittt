...
const users = ["Alex", "Sam", "Taylor"].map((name) => ({
  id: crypto.randomUUID(),
  name,
  email: "fittt-test-" + crypto.randomUUID() + "@example.com",
...
console.log(
  "Created three synthetic test definitions; credentials are in ignored files.",
);
